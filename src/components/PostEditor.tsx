                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-4">
                                            <div className="flex-1">
                                                <input type="number" value={day} onChange={(e) => setDay(e.target.value)} placeholder="DD" className="w-full border border-slate-200 bg-slate-50/50 p-3 text-center font-bold focus:border-gmrt-blue outline-none rounded-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                                            </div>
                                            <div className="flex-1">
                                                <input type="number" value={month} onChange={(e) => setMonth(e.target.value)} placeholder="MM" className="w-full border border-slate-200 bg-slate-50/50 p-3 text-center font-bold focus:border-gmrt-blue outline-none rounded-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                                            </div>
                                            <div className="flex-[1.5]">
                                                <input type="number" value={year} onChange={(e) => setYear(e.target.value)} placeholder="YYYY" className="w-full border border-slate-200 bg-slate-50/50 p-3 text-center font-bold focus:border-gmrt-blue outline-none rounded-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        {isCustomLocation ? (
                                            <input type="text" value={customLocation} onChange={(e) => setCustomLocation(e.target.value)} className="w-full border border-slate-200 bg-slate-50/50 p-3 font-medium focus:border-gmrt-blue outline-none rounded-none" placeholder={lang === 'de' ? "Kategorie eingeben" : "Enter category"} autoFocus />
                                        ) : (
                                            <select value={location} onChange={handleLocationChange} className="w-full border border-slate-200 bg-slate-50/50 p-3 font-medium focus:border-gmrt-blue outline-none rounded-none cursor-pointer">
